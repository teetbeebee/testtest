...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon) {
	...
	//wzw 在程序中进行过escape，在此处进行解码 2007-2-9 17:11
	if (sText != null) sText=unescape(sText);
	if (sXmlSrc != null) sXmlSrc=unescape(sXmlSrc);
	if (sAction != null) sAction=unescape(sAction);
	if (eParent != null) eParent=unescape(eParent);
	if (sIcon != null) sIcon=unescape(sIcon);
	if (sOpenIcon != null) sOpenIcon=unescape(sOpenIcon);
