...
// tooltips
Calendar._TT = {};
// Calendar._TT["INFO"] = "帮助"; // modifyed by hhb 2006-11-08
Calendar._TT["INFO"] = "清空输入";
...
"选择时间:\n" +
"- 点击小时或分钟可使数值加一\n" +
"- 按住Shift键并点击小时或分钟可使数值减一\n" +
"- 点击小时或分钟按住不放并左右拖动鼠标可进行快速改变数值";
...
Calendar._TT["TIME_PART"] = "(Shift-)点击鼠标或左右拖动改变值";
