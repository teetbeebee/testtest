...
public class JsonUtil {
	...
	public static String object2json(Object obj) {
		...
		if (obj == null) {
			...
			json.append("\"").append("byte").append("\"");
			...
			json.append("\"").append(string2json(s)).append("\"");
		} else if (obj instanceof java.sql.Clob) {
			try {
				json.append("\"");
				json.append(string2json(((java.sql.Clob) obj).getSubString(1,
						(int) ((java.sql.Clob) obj).length())));
				json.append("\"");
			} catch (SQLException e) {
				e.printStackTrace();
				json.append("\"java.sql.Clob\"");
			}
		} else if (obj instanceof java.sql.Blob) {
			json.append("\"java.sql.Blob\"");
		} else {
	...
	public static String json2jsonp(String json, String jsonpCallback) {
		return jsonpCallback + "(" + json + ")";
	}

	public static String object2jsonp(Object obj, String jsonpCallback) {
		String json = JsonUtil.object2json(obj);
		return JsonUtil.json2jsonp(json, jsonpCallback);
	}
}
