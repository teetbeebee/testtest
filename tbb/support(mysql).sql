...
drop table TBB_BASEDATA; ----模块相关开始
drop table TBB_PROJ_LIST;
drop table TBB_PROJ_LIST_DETAIL;
drop table TBB_CZBG;
drop table TBB_CZBG_DETAIL; ----模块相关结束
...
CREATE TABLE VPNUSER (                     
           ...
           ACCOUNT       NUMBER(16,2), --ACCOUNT double,    
           PRIMARY KEY  (USER_ID),		
